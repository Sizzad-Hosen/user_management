...
<div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
      ...
      <div className="min-h-[90vh] flex items-center  max-w-md p-6 w-full">
...
<div className="flex justify-around">
            ...
            <button
              disabled={processing}
              onClick={() => closeModal()}
              className="w-full bg-gray-600 hover:bg-gray-700 text-white font-medium py-2.5 rounded-lg transition shadow-sm disabled:opacity-50"
            >
              Cancel
            </button>
</div>
