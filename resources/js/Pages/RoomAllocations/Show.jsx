...
export default function Show() {
  ...
  const userDetails = messUserDetails.mess_user ? messUserDetails.mess_user : null;
  const roomDetails = messUserDetails.room ? messUserDetails.room : null;
          ...
          <table className="w-full border text-sm">
            ...
            <tbody>
                  ...
                  <tr key={roomDetails?.id} className="border-t">
                    ...
                    <td className="p-3">
                      {messUserDetails?.start_date}
                    </td>
                    <td className="p-3">
                      {roomDetails?.end_date || "Still Staying"}
                    </td>
                    <td className="p-3">
                      <span className={`px-2 py-1 rounded text-xs ${
                        messUserDetails?.status === "active"
